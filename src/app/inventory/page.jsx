...
const translations = {
  ar: {
    title: 'نظام الجرد المتقدم',
    listTab: 'قائمة عمليات الجرد',
    createTab: 'إنشاء عملية جرد',
    updateTab: 'تحديث الكميات',
    search: 'البحث في عمليات الجرد...',
  ...
  en: {
    ...
    listTab: 'Inventory Counts List',
    createTab: 'Create Inventory Count',
    updateTab: 'Update Quantities',
    search: 'Search inventory counts...',
    ...
    noItems: 'No items for this count',
