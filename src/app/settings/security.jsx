...
const translations = {
  ar: {
    title: 'ÅÚÏÇÏÇÊ ÇáÃãÇä',
    enable2FA: 'ÊÝÚíá ÇáÊæËíÞ ÇáËäÇÆí (2FA)',
    siemEndpoint: 'ÑÇÈØ äÙÇã SIEM',
    siemApiKey: 'ãÝÊÇÍ API áäÙÇã SIEM',
    save: 'ÍÝÙ ÅÚÏÇÏÇÊ ÇáÃãÇä',
    saved: 'Êã ÍÝÙ ÅÚÏÇÏÇÊ ÇáÃãÇä ÈäÌÇÍ!'
  },
  en: {
