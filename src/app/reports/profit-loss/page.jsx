    ...
    try {
      ...
      if (data.success) {
        ...
        await logActivity({
          ...
          entity_type: 'Report',
          entity_id: null,
          details: ` „ ⁄—÷  ﬁ—Ì— «·√—»«Õ Ê«·Œ”«∆— ··›—⁄ ${branchId} „‰ ${dateRange.from} ≈·Ï ${dateRange.to}`
        });
      } else {
          ...
          <div>
            ...
            <ResponsiveContainer width="100%" height={250}>
              <BarChart data={[{ name: t.revenue, value: report.totalRevenue }, { name: t.expense, value: report.totalExpense }, { name: t.netProfit, value: report.netProfit }]}>
                ...
                <Bar dataKey="value" fill="#10b981" name="«·ﬁÌ„…" />
              </BarChart>
            </ResponsiveContainer>
            <table className="min-w-full divide-y divide-gray-200 mb-4 mt-6">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                ...
                <tr>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 font-bold">{t.netProfit} / («·Œ”«—…)</td>
