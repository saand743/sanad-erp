...
// GET /api/journal-entries - Ã·» ﬁÌÊœ «·ÌÊ„Ì…
export async function GET(request) {
  try {
    ...
    return NextResponse.json({ success: false, error: '›‘· ›Ì Ã·» «·ﬁÌÊœ' }, { status: 500 });
  }
}

// POST /api/journal-entries - ≈÷«›… ﬁÌœ ÌÊ„Ì… ÃœÌœ
export async function POST(request) {
  try {
    ...
    return NextResponse.json({ success: false, error: '›‘· ›Ì ≈÷«›… «·ﬁÌœ' }, { status: 500 });
  }
}
